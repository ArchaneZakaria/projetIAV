    ...
    <div class="container body">
        <div class="top_nav">
          ...
          <div class="col-md-3 col-sm-3 col-xs-12 col-md-offset-5 col-sm-offset-5 ">
              <div class="bgmaskblurb" style="width:80%;margin-top:20%;margin-left:0%;margin-right:auto;padding:20px;text-align:center;box-shadow: 0px 2px 30px #000000;font-size:24px;color:#fff;">
               DLP
              </div>
         </div>
          ...
          <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-2 col-sm-offset-2 " style="width:100%;margin-left:10%">
            ...
            <?php foreach ($applications as $key => $value) {
              ...
              ?>
              <div class="col-sm-3" style="<?= $style ?> width:300px;"  >
                <div class="thumbnail" >
                  <div class="image view view-first" style="text-align:center;" >
                  <a href="#" data="<?= $value->id_application ?>"  class="clss_application"> <img style="width: 100%!important; height: 100px;" src="<?= base_url("uploads/global/".$value->img_application) ?>" alt="image" /> </a>
                  <div class="mask">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12 col-md-offset-5 col-sm-offset-5 ">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-2 col-sm-offset-2 " style="width:100%;margin-left:10%">
                    <div class="col-sm-3" style=" width:300px;"  >
                      <div class="thumbnail" >
                        <div class="image view view-first" style="text-align:center;" >
                        <a href="#" data=""  class="clss_application2"> <img style="width: 100%!important; height: 100px;" src="<?= base_url("uploads/global/".$value->img_application) ?>" alt="image" /> </a>
                        <div class="mask">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12 col-md-offset-5 col-sm-offset-5 ">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-2 col-sm-offset-2 " style="width:100%;margin-left:10%">
                                    <div class="col-sm-3" style=" width:300px;"  >
                                      <div class="thumbnail" >
                                        <div class="image view view-first" style="text-align:center;" >
                                        <a href="#" data=""  class="clss_application3"> <img style="width: 100%!important; height: 100px;" src="<?= base_url("uploads/global/".$value->img_application) ?>" alt="image" /> </a>
                                        <div class="mask">
                                        <p>DCF</p>
                                        </div>
                                        </div>
