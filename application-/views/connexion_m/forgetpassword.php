...
<!--
    ...
    <div class="container">
        ...
        <div class="card card-container">
            ...
            <img id="profile-img" class="profile-img-card" src="<?= base_url('assets/img/logo.png') ?>" />
            <p id="profile-name" class="profile-name-card"></p>
            <form class="form-signin" id='form_dorget' method="post">
...
$("#form_dorget").submit(function functionName(evn) {
  evn.preventDefault();
   $.ajax({
      type: 'POST',
      url: base_url + 'connexion/modifier_motdepass',
        ...
        if(msg.status == 0){
         ...
         for(var i = 0; i<msg.message.length; i++){
          ...
          setTimeout(function(){
           ...
           $("#result_errors").html("<div  class='alert alert-success' style='text-align: center;font-weight: bold;font-style: italic;'>votre mot de passe  a éte modofiee avec success</div>");
           setTimeout(function(){
