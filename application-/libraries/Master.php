...
class Master extends CI_Controller {
    ...
    protected function display ($data='') {
       ...
       $this->template->set_partial('header', 'inc/header', array('header_nav_1' => $header_nav_1, 'header_nav_2' => $header_nav_2, 'header_nav_3' => $header_nav_3,'header_nav_4' => $header_nav_4,'data' => $data,'connected'=>$connct));
    ...
    protected function set_breadcrumb ($links = array()) {
        $this->template->set_partial('breadcrumb', 'breadcrumb_view', array('links' => $links));
    }
