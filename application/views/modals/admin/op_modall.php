    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
           <div class="op_modal_results"></div>
            ...
            <div class="modal-notif" style="background:#969696;text-align:center;">
<span> 1: 2 ans </span> &nbsp; <span> 2: 4 ans </span>
            ...
            <div class="modal-body">
              ...
              <div class="row" id="nb_pr" >
                 <input type="number" class="form-control nb_pr" name="nb_pr" id="nb_prc" placeholder="NB d'années"/>
                 <span></span>
              </div>
              <br/>
              <div class="row" id="nb_ms" >
                 <input type="number" class="form-control nb_ms" name="nb_ms" id="nb_ms" placeholder="NB de mois"/>
                 <span></span>
              </div>
