        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="index.html">Retraite</a>
                        <a href="#" class="x-navigation-control"></a>
                    </li>
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="<?=base_url('assets') ?>/images/users/avatar.jpg" alt="John Doe"/>
                        </a>
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">Benabbes khalid</div>
                    ...
                    <li class="xn-openable">
                        <a href="#"><span class="fa fa-files-o"></span> <span class="xn-text">Retraite</span></a>
                        <ul>
                           <li>
                              <a href="#"><span class="fa fa-envelope"></span> Ajouter </a>
                           </li>
                            <li>
                              <a href="#"><span class="fa fa-envelope"></span> Encours de retraite </a>
                              <a href="#"><span class="fa fa-envelope"></span>  Encours de validation </a>
                              <a href="#"><span class="fa fa-envelope"></span>  Retraité </a>
                            </li>
                          </ul>
                      </li>

                      <li>
                          <a href="#"><span class="fa fa-envelope"></span>Retraite Validée </a>
                      </li>

                      <li>
                          <a href="#"><span class="fa fa-envelope"></span> Prolongation </a>
                      </li>
                      <li>
                          <a href="#"><span class="fa fa-envelope"></span> Statistique </a>
                      </li>
                ...
                <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
                    ...
                    <li class="xn-icon-button pull-right">
                        ...
                        <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
                            ...
                            <div class="panel-footer text-center">
                                <a href="pages-tasks.html">Afficher tous les prolongations en cours</a>
                            </div>
                        </div>
                    </li>
                    <!-- END TASKS -->
