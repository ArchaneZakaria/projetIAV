            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <h5>Les phases de marché fourniture</h5>
                    </div>
                ...
                </div><button class="btn btn-primary" style="border-radius:5px; border: 2px solid #006699;float:right;" type="submit"  data-target="#exampleModalAjouter" data-toggle="modal">Ajouter</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Ajouter une phase aux marché fourniture</h5>
