<h1 class="titrePage">Bons de commande réceptionnés</h1>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title">
                                ...
                                <h5>Les bons de commande receptionnées</h5>
                            </div>
                                            ...
                                            <td class="center">
                                                <div class="">
                                                    <p>
                                                        ...
                                                        <a href="#">
                                                            <span class="glyphicon glyphicon-plus frns " Title="ajouter fournisseurs" data-target="#exampleModalFournisseur"  data-toggle="modal">F</span>
                                                        </a>
                                                        <a href="#">
