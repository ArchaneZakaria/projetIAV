<h1 class="titrePage">Bons de commande en cours</h1>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title">
                                ...
                                <h5>Les bons de commande en cours</h5>
                            </div>
                                                ...
                                                <div class="">
                                                    <p>
                                                       <a href="#">
                                                        ...
                                                        <a href="#">
                                                            <span class="glyphicon glyphicon-plus frns " Title="ajouter fournisseurs" data-target="#exampleModalFournisseur"  data-toggle="modal">Pr</span>
                                                        </a>
                                                        ...
                                                        <a href="#">
                                                            <span class="glyphicon glyphicon-alert yellow" data-target="#alerteModal" data-toggle="modal" Title="Alerter" ></span>
                                                        </a>
                                                    </p>
                                                </div>
                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="hidden-480">
                                                                    ...
                                                                    <i class="glyphicon glyphicon-ok green" data-placement="top" rel="tooltip"   id="HideCache" name="111" data-toggle="modal" data-target="#exampleModalCenter"></i>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
